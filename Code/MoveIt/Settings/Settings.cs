...
namespace MoveIt.Settings
{
    ...
    [SettingsUIMouseAction(QInputSystem.MOUSE_APPLY, ActionType.Button, rebindOptions: RebindOptions.None, ModifierOptions.Allow, false, false, new string[] { "MoveIt_Input" })]
    [SettingsUIMouseAction(QInputSystem.MOUSE_CANCEL, ActionType.Button, rebindOptions: RebindOptions.None, ModifierOptions.Allow, false, false, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardActionAttribute(Inputs.KEY_MOVEDOWN, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardActionAttribute(Inputs.KEY_MOVEUP, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardActionAttribute(Inputs.KEY_MOVEDOWN2, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
    [SettingsUIKeyboardActionAttribute(Inputs.KEY_MOVEUP2, ActionType.Button, rebindOptions: RebindOptions.All, modifierOptions: ModifierOptions.Allow, false, false, Mode.DigitalNormalized, new string[] { "MoveIt_Input" })]
