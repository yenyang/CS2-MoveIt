...
namespace MoveIt.Overlays
{
    internal partial class MIT_OverlaySystem
    {
        ...
        protected struct UpdateOverlaysJob : IJobChunk
        {
            ...
            [ReadOnly]
            public ComponentLookup<Game.Tools.Hidden> m_HiddenLookup;
            ...
            public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
            {
                ...
                while (enumerator.NextEntityIndex(out var idx))
                {
                    ...
                    if (common.m_Owner != Entity.Null &&
                        m_HiddenLookup.HasComponent(common.m_Owner))
                    {
                        continue;
                    }
            ...
            {
                lines.Clear();
                DynamicBuffer<Game.Areas.Node> nodes = blu_AreasNode[common.m_Owner];
                int c = nodes.Length;
